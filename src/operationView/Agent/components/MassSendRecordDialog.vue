...
import { v2GetMassSendList, v2DeleteMassSend, v2SendGroupMessage } from '@/api/tgUser'
...
const handleDelete = async (row: any) => {
  try {
    ...
    // 使用新接口 v2DeleteMassSend
    await v2DeleteMassSend(row.id)
